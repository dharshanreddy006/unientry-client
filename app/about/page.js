...
export const metadata = {
  ...
  description: 'Learn about UniEntry, our mission to help students achieve their dream of studying at top universities worldwide.',
};
      ...
      <section className="hero-gradient pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-white/70 text-lg max-w-2xl mx-auto leading-relaxed">
            UniEntry is a trusted educational consultancy that has helped thousands of students achieve their dream of studying at top universities worldwide.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-accent-50 to-blue-50 rounded-3xl p-8 border border-accent-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                To democratize access to quality international education by providing expert guidance, comprehensive support, and transparent information to every aspiring student, regardless of their background.
              </p>
            </div>
            <div className="bg-gradient-to-br from-primary-50 to-indigo-50 rounded-3xl p-8 border border-primary-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                To become the most trusted and comprehensive education consultancy platform, connecting students with the best universities worldwide and shaping the future leaders of tomorrow.
              </p>
            </div>
          </div>
        </div>
