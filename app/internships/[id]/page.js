      ...
      <section className="section-padding bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              href={`https://wa.me/919876543210?text=Hi%20UniEntry!%20I%20am%20interested%20in%20the%20${encodeURIComponent(internship.role)}%20internship%20at%20${encodeURIComponent(internship.companyName)}.`}
              target="_blank"
